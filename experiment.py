...
from bayes_design.experiments import (
    compare_seq_metric,
...
compare_seq_probs_parser.add_argument(
    "--sequences",
    help="String representations of protein sequences (required if --sequences_path is not provided)",
    nargs="+",
)
compare_seq_probs_parser.add_argument(
    "--sequences_path", help="Path to a sequence file in fasta format (required if --sequences is not provided)"
)
compare_seq_probs_parser.add_argument(
    "--protein_id", help="The PDB id of the structure for the protein sequences", default="6MRR"
)
compare_seq_probs_parser.add_argument(
    "--model_name",
...
compare_seq_probs_parser.add_argument(
    "--metric",
    help="The metric with which to evaluate the sequence",
...
compare_seq_probs_parser.add_argument(
    "--fixed_positions",
    help="The beginnings and ends of residue ranges (includes endpoints [], 1-indexed) to remain fixed and not predicted, separated by spaces",
    nargs="*",
    type=int,
    default=[],
)
compare_seq_probs_parser.add_argument(
    ...
    help="A balancing factor to avoid a high probability ratio in the tails of the distribution. Suggested value: 0.002",
    default=0.002,
    type=float,
)
compare_seq_probs_parser.add_argument(
...
compare_seq_probs_parser.add_argument(
    "--pssm_path", help="The path to a PSSM file used to score a sequence", default=None
)
...
compare_struct_correlation_parser.add_argument(
    "--protein_id", help="The PDB id of the structure for the protein sequences", default="6MRR"
)
compare_struct_correlation_parser.add_argument(
    "--decode_order",
...
compare_struct_correlation_parser.add_argument(
    "--num_variants", help="The number of variants to generate for each sequence", default=10, type=int
)
compare_struct_correlation_parser.add_argument(
    "--perc_residues_to_mutate", help="The percentage of residues to mutate in each variant", default=0.1, type=float
)
compare_struct_correlation_parser.add_argument(
    "--results_dir", help="The directory to store results", default="./results"
)
...
viz_probs_parser.add_argument(
    "--sequence", help="String representations of the protein sequence to redesign", required=True
)
viz_probs_parser.add_argument(
    "--protein_id", help="The PDB id of the structure for the protein sequences", default="6MRR"
)
...
viz_probs_parser.add_argument(
    "--from_scratch",
    help="Whether to design a new sequence from scratch. Default is to condition on existing sequence from provided PDB file.",
    action="store_true",
)
viz_probs_parser.add_argument(
    "--fixed_positions",
...
viz_probs_parser.add_argument(
    "--results_path", help="The directory to store results", default="./results/probs_viz.png"
)
viz_probs_parser.add_argument(
    "--bayes_balance_factor",
    help="A balancing factor to avoid a high probability ratio in the tails of the distribution. Suggested value: 0.002",
...
pssm_parser.add_argument(
    "--sequences", help="String representations of the protein sequence to redesign", nargs="+", default=None
)
...
hist_parser.add_argument(
    "--model_name", help="The name of the model to use", choices=list(model_dict.keys()), default="pssm"
)
hist_parser.add_argument(
    "--metric",
    help="The metric with which to evaluate the sequence",
...
seq_filter_parser.add_argument(
    "--sequences", help="String representations of the protein sequence to redesign", nargs="+", default=None
)
seq_filter_parser.add_argument(
    "--sequences_path", help="Path to the sequence file containing >1 sequence", default=None
)
seq_filter_parser.add_argument(
    "--protein_id", help="The PDB id of the structure for the protein sequences", default="6MRR"
)
